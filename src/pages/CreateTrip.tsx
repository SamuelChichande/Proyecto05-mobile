...
import {
  IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonButton, IonInput, IonItem, IonLabel,
  IonIcon, IonGrid, IonRow, IonCol, IonToggle, IonChip, IonAlert, IonList
} from '@ionic/react';
import {
  closeOutline, locationOutline, calendarOutline, timeOutline, peopleOutline, removeOutline,
  addOutline, pawOutline, bagOutline, banOutline, arrowForwardOutline, helpOutline,
  trendingDownOutline, carSharp
} from 'ionicons/icons';
...
const CreateTrip: React.FC = () => {
  ...
  const [date, setDate] = useState('2026-01-25'); // Fecha del viaje
