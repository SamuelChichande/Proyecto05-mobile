...
const MyTravels: React.FC = () => {
  ...
  const [upcomingTrips] = useState<any[]>([]); // Inicialmente vacío
  const [pastTrips] = useState<any[]>([]);

  const handleCreateTrip = () => {
    // Navegar a la pantalla de crear viaje
    router.push('/maindashboard/create-trip');
  };
        ...
        {selectedSegment === 'upcoming' ? (
          upcomingTrips.length > 0 ? (
                  ...
                  <IonCardContent>
                    ...
                    <div className="card-footer-row">
                      ...
                      <div className="action-buttons">
                        ...
                        <IonButton className="details-btn" onClick={() => router.push('/maindashboard/trip-details')}>
                          Detalles
                        </IonButton>
                      </div>
                    </div>
            ...
            <div className="no-trips-message">
              ...
              <h4>No tienes viajes próximos</h4>
          ...
          pastTrips.length > 0 ? (
            ...
            <div className="no-trips-message">
              <IonIcon icon={car} size="large" color="medium" />
              <h4>No tienes viajes pasados</h4>
              <IonButton fill="outline" onClick={() => router.push('/maindashboard/create-trip')}>
                Crear un viaje
              </IonButton>
            </div>
